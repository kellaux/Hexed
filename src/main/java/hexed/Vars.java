...
import static main.java.hexed.data.PlanetData.*;
...
//                Seq.with(
//                        new Ore(oreCopper, -0.04f, 8f),
//                        new Ore(oreLead, -0.04f, 8f),
//                        new Ore(oreScrap),
//                        new Ore(oreCoal, -0.04f, 8f),
//                        new Ore(oreTitanium, -0.04f, 8f),
//                        new Ore(oreThorium, -0.04f, 8f)
//                ),
